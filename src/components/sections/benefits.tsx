...
export function BenefitsSection() {
  return (
    <section className="relative bg-black py-20 md:py-32">
      ...
      <div className="absolute top-1/4 left-0 w-1/2 h-1/2 bg-gradient-to-l from-accent to-primary rounded-full opacity-10 blur-3xl animate-pulse-gradient [animation-delay:-4s]" />
